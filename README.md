# `paperplanecc/paperplane-api-base` 官方 Docker 镜像 [![Build Status](https://drone.paperplane.cc/api/badges/p01/paperplane-api-base/status.svg)](https://drone.paperplane.cc/p01/paperplane-api-base)
